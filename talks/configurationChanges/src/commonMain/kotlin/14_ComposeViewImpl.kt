    ...
    scene(
        states = listOf(
            ComposeViewImplSceneState(
                kotlinCode = listOf(
                    "abstract class ComposeView(context: Context) : View(context) {\n",
                    "}\n"
            ...
            ComposeViewImplSceneState(
                kotlinCode = listOf(
                    "abstract class ComposeView(context: Context) : View(context) {\n",
                    "    private var configuration by mutableStateOf(resources.configuration)\n",
                    "}\n"
                ).highlight(kotlinHighlighting),
            ),
            ComposeViewImplSceneState(
...
private data class ComposeViewImplSceneState(
